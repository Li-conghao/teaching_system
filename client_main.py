...
class NetworkLoginWindow(LoginWindow):
    ...
    def open_main_window(self):
        ...
        if role == 'admin':
            from gui.network_admin_window import NetworkAdminWindow
            NetworkAdminWindow(self.current_user, self.root, self.client)
        elif role == 'teacher':
            from gui.network_teacher_window import NetworkTeacherWindow
            NetworkTeacherWindow(self.current_user, self.root, self.client)
        elif role == 'student':
            from gui.network_student_window import NetworkStudentWindow
            NetworkStudentWindow(self.current_user, self.root, self.client)
...
class ConnectionDialog:
    ...
    def create_widgets(self):
        ...
        self.host_entry.insert(0, "10.29.4.56")
